...
function getNumberFromString(s) {
  let str = parseFloat(s);
  return isNaN(str) ? "Couldn't extract a number from the provided string." : str;
...
function getIntegerFromString(s) {
  ...
  return !isNaN(num) ? num : "Couldn't extract an integer from the provided string.";
